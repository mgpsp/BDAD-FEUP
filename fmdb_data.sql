...
(8,		"Body 10",	(SELECT userID FROM User WHERE username = "username8"),	(SELECT movieID FROM Movie WHERE title = 'Spider-Man 3')),
(7,		"Body 10",	(SELECT userID FROM User WHERE username = "username4"),	(SELECT movieID FROM Movie WHERE title = 'Tangled')),
(10,	"Body 12",	(SELECT userID FROM User WHERE username = "username6"),	(SELECT movieID FROM Movie WHERE title = 'Pirates of the Caribbean: At World''s End')), 
(6,		"Body 13",	(SELECT userID FROM User WHERE username = "username7"),	(SELECT movieID FROM Movie WHERE title = 'Tangled')), 
(10,	"Body 14",	(SELECT userID FROM User WHERE username = "username4"),	(SELECT movieID FROM Movie WHERE title = 'Spider-Man 3')), 
(9,		"Body 15",	(SELECT userID FROM User WHERE username = "username4"),	(SELECT movieID FROM Movie WHERE title = 'The Hobbit: The Battle of the Five Armies')), 
(5,		"Body 16",	(SELECT userID FROM User WHERE username = "username6"),	(SELECT movieID FROM Movie WHERE title = 'The Chronicles of Narnia: Prince Caspian')), 
(1,		"Body 17",	(SELECT userID FROM User WHERE username = "username9"),	(SELECT movieID FROM Movie WHERE title = 'Pirates of the Caribbean: On Stranger Tides')), 
(7,		"Body 18",	(SELECT userID FROM User WHERE username = "username1"),	(SELECT movieID FROM Movie WHERE title = 'Harry Potter and the Half-Blood Prince')), 
(6,		"Body 19",	(SELECT userID FROM User WHERE username = "username8"),	(SELECT movieID FROM Movie WHERE title = 'The Dark Knight Rises')),
(3,		"Body 20",	(SELECT userID FROM User WHERE username = "username2"),	(SELECT movieID FROM Movie WHERE title = 'Spider-Man 3'))
;
...
((SELECT movieID FROM Movie WHERE title = 'Pirates of the Caribbean: At World''s End'),		(SELECT countryID FROM Country WHERE name = 'UK'),			"2027-05-07",	102),
...
((SELECT movieID FROM Movie WHERE title = 'Tangled'),										(SELECT countryID FROM Country WHERE name = 'USA'),			"2014-11-14",	59),
((SELECT movieID FROM Movie WHERE title = 'Tangled'),										(SELECT countryID FROM Country WHERE name = 'UK'),			"2014-11-16",	80),
((SELECT movieID FROM Movie WHERE title = 'Tangled'),										(SELECT countryID FROM Country WHERE name = 'Canada'),		"2015-11-18",	75),
...
((SELECT movieID FROM Movie WHERE title = 'The Hobbit: The Battle of the Five Armies'),		(SELECT countryID FROM Country WHERE name = 'Canada'),		"2016-12-13",	85),
...
VALUES
('Avatar now has sequel',  'Avatar using HP computers to accelerate rendering.',  '2005-10-20 14:02:52', 7),
('Title 2',  'Proffit beaten by John Carter.',  '2005-11-02 10:44:49', 14),
('Title 3',  'Body 3',  '2006-12-07 06:39:58', 7),
('Title 4',  'Body 4',  '2009-09-16 14:01:08', 13),
('Title 5',  'Tangled now has a new trailer.',  '2010-01-11 11:18:35', 7),
('Title 6',  'Body 6',  '2011-02-02 18:28:27', 13),
('Avatar sequel',  'The sequel to Avatar is in the works.',  '2011-10-29 19:57:30', 14),
('Title 8',  'Body 8',  '2012-02-20 04:50:02', 13),
('Title 9',  'Body 9',  '2012-11-13 11:44:30', 7),
('Tangled set to release in the fall', 'Body 10', '2015-02-21 09:38:25', 7)
;
